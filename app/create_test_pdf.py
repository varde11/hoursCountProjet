...
"""Installé Tesseract depuis ce git: https://github.com/UB-Mannheim/tesseract/wiki 
ne pas forcément coché la case des langues additionnelles, dans le cas de la langue francaise, téléchargé son fichier depuis:
 https://github.com/tesseract-ocr/tessdata/blob/main/fra.traineddata
une fois fait, l'ajouté au dossier" " C:\\Program Files\\Tesseract-OCR\tessdata

après avoir installé pytesseract avec pip install pytesseract, tout en haut du fichierau niveau des import faire ceci:

pytesseract.pytesseract.tesseract_cmd = r"C:\Program Files\Tesseract-OCR\tesseract.exe"
os.environ["TESSDATA_PREFIX"] = r"C:\Program Files\Tesseract-OCR\tessdata"

pour connecter votre pytesseract à Tesseract et ajouté le path au variable d'environement juste le temps de l'exécution du fichier
."""